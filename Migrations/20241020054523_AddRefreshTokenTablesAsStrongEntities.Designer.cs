...
namespace LibraryManagementSystemAPI.Migrations
{
    ...
    [Migration("20241020054523_AddRefreshTokenTablesAsStrongEntities")]
    partial class AddRefreshTokenTablesAsStrongEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryManagementSystemAPI.Data.AdminRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementSystemAPI.Data.AuthorRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementSystemAPI.Data.MemberRefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementSystemAPI.Data.AdminRefreshToken", b =>
                {
                    b.HasOne("LibraryManagementSystemAPI.Data.Admin", "Admin")
                        .WithMany()
                        .HasForeignKey("AdminId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryManagementSystemAPI.Data.Admin", null)
            ...
            modelBuilder.Entity("LibraryManagementSystemAPI.Data.AuthorRefreshToken", b =>
                {
                    b.HasOne("LibraryManagementSystemAPI.Data.Author", null)
                        .WithMany("AuthorRefreshTokens")
            ...
            modelBuilder.Entity("LibraryManagementSystemAPI.Data.MemberRefreshToken", b =>
                {
                    b.HasOne("LibraryManagementSystemAPI.Data.Member", null)
                        .WithMany("MemberRefreshTokens")
            ...
            modelBuilder.Entity("LibraryManagementSystemAPI.Data.Author", b =>
                {
                    b.Navigation("AuthorRefreshTokens");
            ...
            modelBuilder.Entity("LibraryManagementSystemAPI.Data.Member", b =>
                {
                    ...
                    b.Navigation("MemberRefreshTokens");
                });
