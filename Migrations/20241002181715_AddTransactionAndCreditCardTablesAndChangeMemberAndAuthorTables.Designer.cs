...
namespace LibraryManagementSystemAPI.Migrations
{
    ...
    [Migration("20241002181715_AddTransactionAndCreditCardTablesAndChangeMemberAndAuthorTables")]
    partial class AddTransactionAndCreditCardTablesAndChangeMemberAndAuthorTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryManagementSystemAPI.Data.CreditCard", b =>
                {
                    b.Property<int>("MemberId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementSystemAPI.Data.Transaction", b =>
                {
                    ...
                    b.Property<string>("MemberCreditCardNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LibraryManagementSystemAPI.Data.CreditCard", b =>
                {
                    b.HasOne("LibraryManagementSystemAPI.Data.Member", "Member")
                        .WithOne()
                        .HasForeignKey("LibraryManagementSystemAPI.Data.CreditCard", "MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
